...
### 🎁 Whoami — Sorteo de amigo secreto

Aplicación web para crear eventos, invitar participantes y realizar sorteos automáticos de amigo secreto.

**Stack:** Java, Spring Boot, SQL Server, JWT, React, Bootstrap, Azure.
...
### 📱 Apps Android educativas

Aplicaciones móviles para enseñar Kotlin, SQLite, Room, Retrofit, Firebase, Google Maps y autenticación.

**Stack:** Kotlin, Android Studio, SQLite, Room, Retrofit, Firebase.
